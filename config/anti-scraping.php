    ...
    */
    ...
    'limits' => [
        'token' => [
            ...
            'per_hour_ip' => env('ANTI_SCRAPING_TOKEN_HOUR_IP', 60),
            'per_day_ip' => env('ANTI_SCRAPING_TOKEN_DAY_IP', 200),
        ],
        'ofertas' => [
            'per_minute_ip' => env('ANTI_SCRAPING_OFERTAS_MIN_IP', 20),
            'per_minute_token' => env('ANTI_SCRAPING_OFERTAS_MIN_TOKEN', 10),
            'per_hour_ip' => env('ANTI_SCRAPING_OFERTAS_HOUR_IP', 60),
            'per_day_ip' => env('ANTI_SCRAPING_OFERTAS_DAY_IP', 150),
        ],
        'especificaciones' => [
            'per_minute_ip' => env('ANTI_SCRAPING_ESPEC_MIN_IP', 20),
            'per_minute_token' => env('ANTI_SCRAPING_ESPEC_MIN_TOKEN', 10),
            'per_hour_ip' => env('ANTI_SCRAPING_ESPEC_HOUR_IP', 60),
            'per_day_ip' => env('ANTI_SCRAPING_ESPEC_DAY_IP', 150),
        ],
        'historicos' => [
            'per_minute_ip' => env('ANTI_SCRAPING_HISTORICOS_MIN_IP', 30),
            'per_hour_ip' => env('ANTI_SCRAPING_HISTORICOS_HOUR_IP', 120),
            'per_day_ip' => env('ANTI_SCRAPING_HISTORICOS_DAY_IP', 200),
        ],
    ],
