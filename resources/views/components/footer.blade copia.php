    ...
    <div class="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-3 gap-12 text-left items-start">
        ...
        <div class="px-2 md:pl-28">
            ...
            <div class="flex space-x-4 mb-4">
                <a href="#" class="text-white transition-colors hover:!text-[#e97b11]" aria-label="Facebook">
                ...
                <a href="#" class="text-white transition-colors hover:!text-[#e97b11]" aria-label="Instagram">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            {{-- añadirCam() -> _f1() --}}
            <a href="{{ _f1(route('politicas.contacto')) }}" class="block text-white transition-colors hover:!text-[#e97b11]">Contáctanos</a>
            <a href="{{ _f1(route('politicas.contacto')) }}" class="block text-white transition-colors hover:!text-[#e97b11]">Colaboraciones</a>
        </div>
        ...
        <div class="px-6 md:pl-36">
            ...
            <ul class="space-y-2">
                <li><a href="{{ route('politicas.aviso-legal') }}" class="text-white transition-colors hover:!text-[#e97b11]">Aviso legal</a></li>
                <li><a href="{{ route('politicas.privacidad') }}" class="text-white transition-colors hover:!text-[#e97b11]">Política de privacidad</a></li>
                <li><a href="{{ route('politicas.cookies') }}" class="text-white transition-colors hover:!text-[#e97b11]">Política de cookies</a></li>
            </ul>
        </div>
