        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-2 sm:space-x-5 overflow-x-auto pb-1 scrollbar-hide" style="-webkit-overflow-scrolling: touch;">
                ...
                <a href="{{ _f1(route('categoria.show', 'electronica')) }}" class="group flex flex-col items-center space-y-1 sm:space-y-1.5 min-w-[60px] sm:min-w-[80px] flex-shrink-0 transition-all duration-200">
                    <div class="w-10 h-10 sm:w-14 sm:h-14 bg-pink-100 rounded-xl flex items-center justify-center transition-all duration-200 group-hover:bg-pink-200 group-hover:scale-105">
                        <img src="{{ asset('images/categorias/electronica.webp') }}" 
                             alt="Icono categoria Electrónica" 
                             class="w-6 h-6 sm:w-8 sm:h-9" />
                    </div>
                    <span class="categoria-texto-movil text-[8px] sm:text-sm font-medium text-gray-700 group-hover:text-pink-600 text-center transition-colors">Electrónica</span>
                </a>
                ...
                >
                    <div class="w-10 h-10 sm:w-14 sm:h-14 bg-pink-100 rounded-xl flex items-center justify-center transition-all duration-200 group-hover:bg-pink-200 group-hover:scale-105">
                        <svg class="w-6 h-6 sm:w-8 sm:h-9 text-pink-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                        </svg>
                    </div>
                    <span class="categoria-texto-movil text-[8px] sm:text-sm font-medium text-gray-700 group-hover:text-pink-600 text-center transition-colors">Más <span class="text-pink-600">></span></span>
                </a>
            </div>
            {{-- añadirCam() -> _f1() --}}
            <a href="{{ _f1(route('categorias.todas')) }}"
               class="hidden sm:flex items-center justify-center bg-pink-500 hover:bg-pink-600 text-white rounded-lg transition-colors flex-shrink-0 ml-4
