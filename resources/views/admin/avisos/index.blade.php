...
<x-app-layout>
                ...
                @if(auth()->id() === 1)
                    <div class="flex items-center space-x-2">
                        ...
                        <button type="button" 
                                ...
                                aria-label="Ayuda" 
                                data-tooltip="Si marcamos este check se mostrarán también los avisos de oferta de tiendas marcadas como no mostrar"
    ...
    <script>
        ...
        // Toggle: incluir avisos de oferta de tiendas no visibles (solo usuario ID 1)
