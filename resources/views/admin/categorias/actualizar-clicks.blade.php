                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="mb-6">
                        ...
                        <p class="text-gray-600 dark:text-gray-400 mb-4">
                            Este proceso actualizará los clicks de todas las categorías basándose en los clicks de las ofertas de productos 
                            pertenecientes a cada categoría y sus subcategorías de los últimos 7 días.
                        </p>
                    ...
                    <div id="progreso-container" class="hidden mb-6">
                        <div class="mb-4">
                            <div class="flex justify-between text-sm text-gray-600 dark:text-gray-400 mb-2">
                                <span id="categoria-actual">Procesando...</span>
    ...
    <script>
        document.getElementById('btn-iniciar').addEventListener('click', function() {
            ...
            function actualizarProgreso() {
                fetch('{{ route("admin.categorias.actualizar.clicks.procesar") }}', {
                    method: 'POST',
                    headers: {
                ...
                .then(data => {
                    if (data.progreso !== undefined) {
                        ...
                        contadorProgreso.textContent = `${data.categorias_procesadas} / ${data.total_categorias}`;
                        categoriaActual.textContent = `Procesando: ${data.categoria_actual}`;
