...
class FarmaciamamironController extends PlantillaTiendaController
{
    /**
     * Extrae el precio de una página de Farmacia Mamiron.
     * - Prioriza <meta property="product:price:amount" content="…">.
     * - Luego busca <span itemprop="price" class="product-price" content="…">.
     * - Fallback: valor visible dentro de <span class="product-price">…</span>.
     * - Otro respaldo: <div id="pepper-product-price">…</div> (oculto).
    ...
    public function obtenerPrecio($url, $variante = null, $tienda = null): JsonResponse
    {
        ...
        // 1) <meta property="product:price:amount" content="7.18">
        if (preg_match(
        ...
        // 2) <span itemprop="price" class="product-price" content="7.18">
        if (preg_match(
        ...
        // 3) Visible dentro de <span class="product-price">7,18 €</span>
        if (preg_match(
        ...
        // 4) <div id="pepper-product-price">7.18</div>
        if (preg_match(
        ...
        return response()->json([
            'success' => false,
            'error'   => 'No se pudo encontrar el precio en la página de Farmacia Mamiron',
        ]);
    }

    /**
     * Convierte "7,18", "7.18" o "1.234,56" a float con punto decimal.
     */
